...
class StudyMode:
    ...
    def __init__(self, name: str, work_time: int, rest_time: int,
        ...
        self.led_color = led_color        # (R, G, B) 0-255
...
class PomodoroApp(App):
    ...
    def build(self):
        # ── Modos predefinidos ──
        self.modes = {
            "Clásico":     StudyMode("Clásico",    25*60,  5*60, (255, 60,  0),
                                     "25 min trabajo · 5 min descanso"),
            "Invertido":   StudyMode("Invertido",   5*60, 25*60, (200, 40, 200),
                                     "5 min trabajo · 25 min descanso"),
            "Flowmodoro":  StudyMode("Flowmodoro", 35*60, 10*60, (30, 120, 255),
                                     "Flujo libre · pausa sugerida a 35 min"),
            "Custom":      StudyMode("Custom",     25*60,  5*60, (255, 200, 0),
    ...
    def _build_status_section(self):
        ...
        box.add_widget(make_label("Estado del dispositivo", size=11,
                                  color=C_MUTED))
        self.led_status = make_label("LED: —", size=12, color=C_TEXT)
    ...
    def _on_state_change(self, state: str):
        def update(_):
            ...
            r, g, b, _ = color
            self.led_status.text = (f"LED: RGB({int(r*255)}, "
    ...
    def _on_bt_data(self, data: str):
        def update(_):
            ...
            if data == "PONG":
                ...
                self.sensor_label.text = "✓ LED actualizado correctamente"
                self.sensor_label.color = C_REST
            elif data.startswith("LED_SET"):
    ...
    def _open_custom_popup(self):
        ...
        def save(_):
            ...
            r = int(self._rest_slider.value) * 60
            self.modes["Custom"] = StudyMode("Custom", w, r, (255, 200, 0),
                                             "Modo personalizado")
        ...
        popup = Popup(title="Modo personalizado", content=content,
                      size_hint=(0.9, 0.55))
        popup.open()
